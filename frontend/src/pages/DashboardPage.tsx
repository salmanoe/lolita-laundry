...
import { BasketIcon, ChartIcon, InvoiceIcon, TowelsIcon } from '../components/NavIcons'
...
/**
 * Dashboard — operational summary cards (Phase 4). Money is billable orders by order date.
 */
